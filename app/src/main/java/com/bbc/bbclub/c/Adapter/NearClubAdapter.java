...
public class NearClubAdapter extends BaseQuickAdapter<PersonItem,CommonViewHolder> {
    public NearClubAdapter() {
        super(R.layout.item_club_view, DataServer.getSampleData(10));
    }
