...
public class MatchAdapter extends BaseQuickAdapter<PersonItem,CommonViewHolder> implements BaseQuickAdapter.OnItemChildClickListener,BaseQuickAdapter.OnItemClickListener{
    public MatchAdapter() {
        super(R.layout.item_match_view, DataServer.getSampleData(3));
    }
