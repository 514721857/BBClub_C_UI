...
public class MyMatchAdapter extends BaseQuickAdapter<PersonItem,CommonViewHolder> implements BaseQuickAdapter.OnItemChildClickListener,BaseQuickAdapter.OnItemClickListener{
    public MyMatchAdapter() {
        super(R.layout.item_mymatch_view, DataServer.getSampleData(1));
    }


    @Override
    protected void convert(CommonViewHolder baseViewHolder, PersonItem personItem) {
        baseViewHolder.addOnClickListener(R.id.find_info);
